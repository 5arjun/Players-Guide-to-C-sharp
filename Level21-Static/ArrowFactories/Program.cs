...
class Arrow
{
    ...
    public static Arrow CreateEliteArrow() => new Arrow(steel, plastic, 95);  
    public static Arrow CreateBeginnerArrow() => new Arrow(wood, goose, 75);  
    public static Arrow CreateMarksmanArrow() => new Arrow(steel, goose, 65);  
